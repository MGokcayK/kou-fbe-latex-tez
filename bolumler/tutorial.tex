...
Şekil için dikkat edilecek hususlardan biri şekil açıklamasının şeklin altında olmasıdır. Bunun için tablonun aksine "$\backslash$caption\{\}" komutu ""$\backslash$includegraphics\{\}" komutunun altında olmalıdır. Şekil \ref{fig:kou} oluşturan kod parçası Şekil \ref{code:figure} ile gösterilmiştir.
